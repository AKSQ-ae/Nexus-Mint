    ...
    <Dialog>
      <DialogTrigger asChild>
        <Button 
          variant="outline" 
          size="sm" 
          className="fixed bottom-4 right-4 z-30 h-14 w-14 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 border-primary/20 bg-gradient-to-br from-white/95 to-primary/5 backdrop-blur-sm hover:scale-105 group"
        >
