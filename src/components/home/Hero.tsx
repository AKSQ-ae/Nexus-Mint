    ...
    <section className="bg-white text-foreground relative overflow-hidden" style={{background: 'radial-gradient(ellipse at center, rgba(30, 144, 255, 0.03) 0%, rgba(255, 255, 255, 1) 70%)'}}>
      ...
      <div className="container mx-auto px-4 py-32 lg:py-40 relative z-10">
        <div className="max-w-5xl mx-auto text-center">
          ...
          {/* Global Access. Local Returns Section */}
          <div className="animate-fade-in-up mt-16 text-center" style={{animationDelay: '0.9s'}}>
            ...
            <p className="text-lg text-muted-foreground font-inter max-w-2xl mx-auto mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-4xl mx-auto mb-12">
              ...
              <div className="bg-white/80 backdrop-blur-sm border border-grey-light/30 rounded-2xl p-6 shadow-elegant hover:shadow-glow transition-all duration-300 hover:scale-105 group">
                ...
                <p className="text-muted-foreground font-inter font-medium">Global Investors</p>
              </div>
              ...
              <div className="bg-white/80 backdrop-blur-sm border border-grey-light/30 rounded-2xl p-6 shadow-elegant hover:shadow-glow transition-all duration-300 hover:scale-105 group">
                ...
                <p className="text-muted-foreground font-inter font-medium">Projected p.a. Returns</p>
              </div>
            </div>
            ...
            <div className="max-w-4xl mx-auto text-left space-y-6 mb-12">
              <div className="flex items-start gap-4">
                <div className="w-2 h-2 bg-blue-primary rounded-full mt-3 flex-shrink-0"></div>
                <div>
                  <span className="text-blue-primary font-semibold font-inter">Effortless Diversification</span>
                  <span className="text-muted-foreground font-inter"> – Allocate AED 100 across a basket of vetted UAE properties in one click for balanced, low-risk exposure.</span>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                <div className="w-2 h-2 bg-blue-primary rounded-full mt-3 flex-shrink-0"></div>
                <div>
                  <span className="text-blue-primary font-semibold font-inter">Institutional-Grade Security</span>
                  <span className="text-muted-foreground font-inter"> – Enterprise-level encryption and multi-signature custody keep your capital rock-solid.</span>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                <div className="w-2 h-2 bg-blue-primary rounded-full mt-3 flex-shrink-0"></div>
                <div>
                  <span className="text-blue-primary font-semibold font-inter">Advanced Tokenization Technology</span>
                  <span className="text-muted-foreground font-inter"> – On-chain property tokenization delivers instant settlement, full transparency, and seamless fractional ownership.</span>
                </div>
              </div>
            </div>
