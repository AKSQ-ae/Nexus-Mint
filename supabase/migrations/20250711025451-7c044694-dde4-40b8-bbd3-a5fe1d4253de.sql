-- Add realistic property data for Nexus Mint platform
...
(
  'Business Bay Tower',
  'Modern commercial and residential tower in Dubai Business Bay, featuring premium office spaces and luxury apartments with excellent connectivity and investment potential.',
  'Business Bay, Dubai',
...
(
  ...
  'Exclusive luxury residences in the heart of Downtown Dubai, offering unparalleled views of Burj Khalifa and Dubai Fountain with premium amenities and services.',
  'Downtown Dubai, UAE',
...
-- Add token supply data for the properties
...
SELECT 
  ...
  price_per_token,
  min_investment,
  price_per_token * 10000 -- max investment of 10,000 tokens
FROM properties 
